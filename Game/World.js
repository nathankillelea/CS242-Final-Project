     ...
     */
     initializePickUps() {
        ...
        for(let i = 0; i < spikeTrapCap; i++)
              this.groundWeapons.push(new GroundSpikeTrap(Util.randomIntFromInterval(250, 9750), Util.randomIntFromInterval(250, 5375)));
        for(let i = 0; i < tarTrapCap; i++)
              this.groundWeapons.push(new GroundTarTrap(Util.randomIntFromInterval(250, 9750), Util.randomIntFromInterval(250, 5375)));
